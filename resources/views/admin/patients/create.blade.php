<x-layouts.app title="Register Patient | Assam Health Card">
    <div class="min-h-screen bg-gradient-to-br from-blue-50 via-green-50 to-blue-50 py-8 px-4">
        <div class="max-w-2xl mx-auto">
            ...
            <div class="mb-8 animate-slide-in-down">
                ...
                <h1 class="text-3xl md:text-4xl font-bold text-gray-900 mt-4">Register New Patient</h1>
            ...
            <div class="bg-white rounded-2xl border border-gray-200 shadow-sm p-8 animate-slide-in-up">
                <form method="POST" action="{{ route('admin.patients.store') }}" class="space-y-6" enctype="multipart/form-data">
                    @csrf
                    ...
                    <div>
                        ...
                        >
                            ...
                            <option value="individual" {{ old('card_type') === 'individual' ? 'selected' : '' }}>Individual Card</option>
                            <option value="family" {{ old('card_type') === 'family' ? 'selected' : '' }}>Family Card</option>
                        </select>
                        @error('card_type')
                            <p class="text-red-600 text-sm mt-1">{{ $message }}</p>
                        @enderror
                    ...
                    <div>
                        ...
                        >
                            ...
                            <option value="aadhar" {{ old('address_proof_type') === 'aadhar' ? 'selected' : '' }}>Aadhar Card</option>
                            ...
                            <option value="rental_agreement" {{ old('address_proof_type') === 'rental_agreement' ? 'selected' : '' }}>Rental Agreement</option>
                            <option value="other" {{ old('address_proof_type') === 'other' ? 'selected' : '' }}>Other</option>
                        </select>
                    ...
                    <div>
                        <label class="block text-sm font-semibold text-gray-700 mb-2">
                            ...
                            Card Validity Date <span class="text-xs text-gray-500 font-normal">(Optional - default 1 year, auto-inactive after)</span>
                        </label>
                        <input
                            type="date"
                            name="card_validity_date"
                            value="{{ old('card_validity_date') }}"
                    ...
                    <div class="flex gap-3 pt-6 border-t border-gray-200">
                        <a href="{{ route('admin.patients.index') }}" class="flex-1 px-6 py-2.5 border border-gray-300 text-gray-700 rounded-lg font-semibold hover:bg-gray-50 transition-smooth text-center">
                            Cancel
                        </a>
                        <button
                            type="submit"
